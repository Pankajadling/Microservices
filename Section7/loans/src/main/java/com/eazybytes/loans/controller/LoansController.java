...
import com.eazybytes.loans.dto.LoanContactInfoData;
...
public class LoansController {
    ...
    // 3rd approach
    @Autowired
    private LoanContactInfoData loanContactInfoData; // Get environment variable from properties or yml file


    @Operation(
            summary = "Hello Loans REST API",
            description = "REST API for Hello Loans inside EazyBank"
    ...
    @GetMapping("/helloLoans")
    //    New Hello Loans API
    public ResponseEntity<Map<String, String>> getHelloLoansMessage() {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(Map.of("message", "Hello Loans V1 !!!!!!!"));
    }
    ...
    //    New Hello Account API
    public ResponseEntity<LoanContactInfoData> getContactInfo() {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(loanContactInfoData);
    }
